...
| 2 | Pemetaan pola ancaman ke MITRE ATT&CK | Enrichment Logstash `translate`: 1000010→T1046, 1000020→T1110.001, 1000030→T1595.002 | ✅ Terbukti |
...
| Hydra (11–20) | T1110.001 | 1,6 s (1–4) | 5,3 s (2–9) | ya — Wazuh 5763 → firewall-drop |
